...
<details>
	<summary>**What method do we call to mutate (change) state?**</summary>
>`setState()`
</details>

<details>
	<summary>**Slightly obvious, yet confusing question: To what object does that method belong to?**</summary>
...
<details>
	<summary>**What component owns the `selColorIdx` state property?**</summary>
>`<App />`
</details>

<details>
	<summary>**Where are we going to have to put the method that calls `setState()` to change the value of `selColorIdx`?**</summary>
>`Within <App />, of course!`
</details>
...
<details>
<summary>**Why is `this` within `handleColorSelection` being bound to the `props` object?**</summary>
The binding of `this` is determined by how a function is called. In this case, since `handleColorSelection` method is attached to the `props` object - it is the object left of the dot...</details>
</detail>
